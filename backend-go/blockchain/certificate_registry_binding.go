...
//
// Solidity: function issueCertificate(bytes32 _certHash) returns()
func (_CertificateRegistry *CertificateRegistryTransactor) IssueCertificate(opts *bind.TransactOpts, _certHash [32]byte) (*types.Transaction, error) {
	return _CertificateRegistry.contract.Transact(opts, "issueCertificate", _certHash)
}

// IssueCertificate is a paid mutator transaction binding the contract method 0xa1f81824.
//
// Solidity: function issueCertificate(bytes32 _certHash) returns()
func (_CertificateRegistry *CertificateRegistrySession) IssueCertificate(_certHash [32]byte) (*types.Transaction, error) {
	return _CertificateRegistry.Contract.IssueCertificate(&_CertificateRegistry.TransactOpts, _certHash)
}

// IssueCertificate is a paid mutator transaction binding the contract method 0xa1f81824.
//
// Solidity: function issueCertificate(bytes32 _certHash) returns()
func (_CertificateRegistry *CertificateRegistryTransactorSession) IssueCertificate(_certHash [32]byte) (*types.Transaction, error) {
	return _CertificateRegistry.Contract.IssueCertificate(&_CertificateRegistry.TransactOpts, _certHash)
}

// RevokeCertificate is a paid mutator transaction binding the contract method 0xc6cbc52a.
//
// Solidity: function revokeCertificate(bytes32 _certHash) returns()
func (_CertificateRegistry *CertificateRegistryTransactor) RevokeCertificate(opts *bind.TransactOpts, _certHash [32]byte) (*types.Transaction, error) {
	return _CertificateRegistry.contract.Transact(opts, "revokeCertificate", _certHash)
}

// RevokeCertificate is a paid mutator transaction binding the contract method 0xc6cbc52a.
//
// Solidity: function revokeCertificate(bytes32 _certHash) returns()
func (_CertificateRegistry *CertificateRegistrySession) RevokeCertificate(_certHash [32]byte) (*types.Transaction, error) {
	return _CertificateRegistry.Contract.RevokeCertificate(&_CertificateRegistry.TransactOpts, _certHash)
}

// RevokeCertificate is a paid mutator transaction binding the contract method 0xc6cbc52a.
//
// Solidity: function revokeCertificate(bytes32 _certHash) returns()
func (_CertificateRegistry *CertificateRegistryTransactorSession) RevokeCertificate(_certHash [32]byte) (*types.Transaction, error) {
	return _CertificateRegistry.Contract.RevokeCertificate(&_CertificateRegistry.TransactOpts, _certHash)
}
...
//
// Solidity: event CertificateIssued(bytes32 certHash, address issuer)
func (_CertificateRegistry *CertificateRegistryFilterer) FilterCertificateIssued(opts *bind.FilterOpts) (*CertificateRegistryCertificateIssuedIterator, error) {

	logs, sub, err := _CertificateRegistry.contract.FilterLogs(opts, "CertificateIssued")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event CertificateIssued(bytes32 certHash, address issuer)
func (_CertificateRegistry *CertificateRegistryFilterer) WatchCertificateIssued(opts *bind.WatchOpts, sink chan<- *CertificateRegistryCertificateIssued) (event.Subscription, error) {

	logs, sub, err := _CertificateRegistry.contract.WatchLogs(opts, "CertificateIssued")
	if err != nil {
		return nil, err
	}
...
// FilterCertificateRevoked is a free log retrieval operation binding the contract event 0x44d80a438cb4fa3b5aedbe551ce3d9382e37f446917b783e1dee70a03b4180e3.
//
// Solidity: event CertificateRevoked(bytes32 certHash)
func (_CertificateRegistry *CertificateRegistryFilterer) FilterCertificateRevoked(opts *bind.FilterOpts) (*CertificateRegistryCertificateRevokedIterator, error) {

	logs, sub, err := _CertificateRegistry.contract.FilterLogs(opts, "CertificateRevoked")
	if err != nil {
		return nil, err
	}
...
// WatchCertificateRevoked is a free log subscription operation binding the contract event 0x44d80a438cb4fa3b5aedbe551ce3d9382e37f446917b783e1dee70a03b4180e3.
//
// Solidity: event CertificateRevoked(bytes32 certHash)
func (_CertificateRegistry *CertificateRegistryFilterer) WatchCertificateRevoked(opts *bind.WatchOpts, sink chan<- *CertificateRegistryCertificateRevoked) (event.Subscription, error) {

	logs, sub, err := _CertificateRegistry.contract.WatchLogs(opts, "CertificateRevoked")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseCertificateRevoked is a log parse operation binding the contract event 0x44d80a438cb4fa3b5aedbe551ce3d9382e37f446917b783e1dee70a03b4180e3.
//
// Solidity: event CertificateRevoked(bytes32 certHash)
